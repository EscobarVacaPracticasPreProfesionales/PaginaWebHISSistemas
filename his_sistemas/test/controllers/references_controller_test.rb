...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post references_url, params: { reference: { content: @reference.content, pictures: @reference.pictures, title: @reference.title, user_id: @reference.user_id, year: @reference.year } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { content: @reference.content, pictures: @reference.pictures, title: @reference.title, user_id: @reference.user_id, year: @reference.year } }
